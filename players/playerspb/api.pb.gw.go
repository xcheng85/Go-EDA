...
/*
Package playerspb is a reverse proxy.
...
func RegisterPlayersServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PlayersServiceServer) error {
	...
	mux.Handle("GET", pattern_PlayersService_GetPlayer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/playerspb.PlayersService/GetPlayer", runtime.WithHTTPPathPattern("/api/players/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PlayersService_GetPlayer_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_PlayersService_GetPlayer_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPlayersServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PlayersServiceClient) error {
	...
	mux.Handle("GET", pattern_PlayersService_GetPlayer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/playerspb.PlayersService/GetPlayer", runtime.WithHTTPPathPattern("/api/players/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PlayersService_GetPlayer_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_PlayersService_GetPlayer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "players", "id"}, ""))
)

var (
	forward_PlayersService_GetPlayer_0 = runtime.ForwardResponseMessage
)
